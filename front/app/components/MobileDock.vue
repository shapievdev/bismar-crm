...
/**
 * Страница может попросить убрать полосу — так делает открытый разговор.
 *
 * Просьба исполняется только там, где страница и правда занимает экран целиком:
 * на планшете мессенджер показывает обе панели сразу, и разделы оттуда убирать
 * не за что. Решает это ширина экрана, а не сама страница, — см. стили ниже.
 */
...
<template>
  <div class="dock-layer" :class="{ 'dock-layer--away': hideDock }">
    <!--
...
/*
 * Страница попросила экран целиком — уходим.
 *
 * Только на телефоне, где страница и правда одна: на планшете мессенджер
 * показывает и список, и ленту сразу, и убирать оттуда разделы не за что.
 * Граница та же, по которой мессенджер сворачивается в одну панель.
 */
