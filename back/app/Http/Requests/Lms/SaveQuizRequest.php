...
final class SaveQuizRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            /*
             * Кто выносит приговор: приложение или человек.
             *
             * Поля может не быть — тогда вид теста остаётся прежним, а у нового
             * теста он обычный (см. SaveQuiz::reviewerOf). Умолчанием здесь
             * распоряжаться нельзя: пока отсутствие поля означало «обычный»,
             * оно заодно обнуляло проверяющего, и сданные работы пропадали из
             * его очереди — так на боевом 2026-09-25 повисли четыре
             * аттестации.
             */
