...
return [
    ...
    */
    ...
    'meilisearch' => [
        ...
        /*
         * Порядок полей — это и порядок важности: совпадение в названии весит
         * больше, чем в ключевых словах, а те — больше, чем в описании.
         * Ключевые слова стоят вторыми намеренно: их пишут затем, чтобы
         * материал нашли теми словами, которых нет в его тексте.
         *
         * Ключ — класс модели: имя индекса Scout возьмёт у неё же вместе с
         * префиксом, и разойтись они не смогут.
         */
        'index-settings' => [
            Course::class => [
                'searchableAttributes' => ['title', 'keywords', 'summary', 'description'],
            ],
            Regulation::class => [
                'searchableAttributes' => ['title', 'keywords', 'summary'],
            ],
        ],
        'model-settings' => [],
    ],
